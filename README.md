...
## [画面録画](https://math-u-t.github.io/web-app/pages/screen-record.html)

### 機能

- 指定した画面を録画します。

- 音声を付けるか付けないかの設定ができます。

- 録画した動画はすぐに`.webm`形式でダウンロードされます。

- 画質が悪いかもしれません。

- 主にログを取るように使うべきだと思います。

## [画面録画](https://math-u-t.github.io/web-app/pages/paint-edit.html)
